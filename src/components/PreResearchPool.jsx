...
function marketMetrics(item, products, updateTime) {
  ...
  const baselineTotal = peers.reduce((sum,p) => sum+(num(p.baselineScaleYi)||0),0)
  const scaleIncrease = total-baselineTotal
  ...
  return { count:peers.length, launched12, launched90, total, baselineTotal, scaleIncrease, topShare:total ? top/total*100 : null, top3Share:total ? top3/total*100 : null, gapScore, state, peers:peers.sort((a,b)=>(b.currentScaleYi||0)-(a.currentScaleYi||0)) }
}
