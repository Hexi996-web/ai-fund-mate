...
test('shows public-data evidence and drills into product supply', async ({ page }) => {
  ...
  await expect(page.getByText('收入增速中位数', { exact: true })).toBeVisible()
  await expect(page.getByText('财报样本覆盖', { exact: true })).toBeVisible()
  await page.getByRole('button', { name: '关闭', exact: true }).click()
  await page.getByRole('button', { name: /资产承载/ }).click()
